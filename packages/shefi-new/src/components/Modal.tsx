    ...
    >
      ...
      >
        ...
        {showCloseButton && (
          <button
            onClick={onClose}
            className="absolute z-50 right-4 top-4 flex h-8 w-8 items-center justify-center rounded-full text-brand-dark/60 transition-colors hover:bg-brand-light hover:text-brand-dark"
