...
import { GenericSubname } from "./useSubnames";
...
export const SingleSubname = ({
  ...
  const mintBtnLabel = btnState.waitingTx
    ? "Waiting for tx..."
    : btnState.waitingWallet
      ? "Waiting for wallet..."
      : "Update";
            ...
            <Flex flexWrap="wrap" justifyContent="center">
              {Object.values(KnownAddresses).map((knownAddr) => (
                <Flex
                  ...
                  color={themeVariables.accent}
                  background={
                    subname.addresses[knownAddr.coinType]
                      ? "rgb(255,255,255, 0.2)"
                      : "transparent"
                  }
                  p={2}
